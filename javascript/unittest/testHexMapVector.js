...
function testHexMapVectorDistance() {
    ...
    assertEquals("UNIT 0 to (6, -2)", 7, HexMap.Vector.UNIT[0].distance(hv0));
    assertEquals("UNIT 1 to (6, -2)", 7, HexMap.Vector.UNIT[1].distance(hv0));
    assertEquals("UNIT 2 to (6, -2)", 8, HexMap.Vector.UNIT[2].distance(hv0));
    assertEquals("UNIT 3 to (6, -2)", 9, HexMap.Vector.UNIT[3].distance(hv0));
    assertEquals("UNIT 4 to (6, -2)", 9, HexMap.Vector.UNIT[4].distance(hv0));
    assertEquals("UNIT 5 to (6, -2)", 8, HexMap.Vector.UNIT[5].distance(hv0));
